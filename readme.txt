...
2. Что я сделал в итоге?
	...
	2.1. Стандартная клавиатура только в ISO раскладке, потому что:
		...
		- можно сместить левую половину нижнего буквенного ряда влево для достижения симметрии движения при наборе на правой и левой половинах
