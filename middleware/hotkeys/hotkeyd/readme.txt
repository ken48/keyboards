...
в Accessibility/Input Monitoring нужно добавить именно этот бинарь python: /usr/bin/python3
Если использовать pyenv, то будет много суеты, так как pyenv требует доп енвайронмент вариаблов.
